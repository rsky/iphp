...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/tmp/php' '--host=i686-apple-darwin' '--build=i686-apple-darwin11' '--enable-embed=static' '--disable-cli' '--disable-cgi' '--with-zlib' '--without-iconv'"
...
#define PHP_EXTENSION_DIR       "/tmp/php/lib/php/extensions/no-debug-non-zts-20100525"
